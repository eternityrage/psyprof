...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "🧠 Psychology Professor Daily!\n\n#psychology #brain #education #science"
        ...
        video = upload.video(
            ...
            name=title or 'Psychology Professor Video',
...
def main():
    ...
    title = sys.argv[3] if len(sys.argv) > 3 else "Psychology Professor"
